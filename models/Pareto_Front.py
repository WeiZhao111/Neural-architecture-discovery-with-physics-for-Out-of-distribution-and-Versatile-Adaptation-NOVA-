...
# file1 = np.load('Data_P.npz')
# bc_loss_ds_all, pde_loss_ds_all, bc_loss_ds_best, pde_loss_ds_best, bc_loss_mse_ds_best, pde_loss_mse_ds_best, mse_itera, loss_itera = file1['arr_0'], file1['arr_1'], file1['arr_2'], file1['arr_3'], file1['arr_4'], file1['arr_5'], file1['arr_6'], file1['arr_7']
# lambda_name = np.array([0.001, 0.01, 0.1, 1.0, 10.0, 100.0, 1000.0])
# bc_pde_mse = np.array([bc_loss_ds_all[0, :], pde_loss_ds_all[0, :]/lambda_name[0], loss_itera[0, :], mse_itera[0, :]])
# bc_pde_mse = bc_pde_mse.T


# pop_obj = bc_pde_mse[:, 0:2]
